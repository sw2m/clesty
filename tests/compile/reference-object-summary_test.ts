/**
 * Red-Gate scaffold for sw2m/clesty issue #281 — Reference Object `summary`.
 *
 * staging: tests are stubbed (`Deno.test.ignore`) until #281 grows a tech
...
// grows the wiring for Reference Object `summary`.
...
const FIXTURE_DIR = fromFileUrl(
  new URL("../fixtures/reference-object-summary/", import.meta.url),
);
...
Deno.test.ignore(
  "#281 (wip): Reference Object `summary` — primary contract",
  () => {
    // staging: replace this stub once the tech spec on #281 pins down the
...
Deno.test.ignore(
  "#281 (wip): Reference Object `summary` — refusal / edge case",
  () => {
    // staging: replace this stub once the tech spec on #281 pins the
