/**
 * Red-Gate scaffold for sw2m/clesty issue #227 — Schema `nullable`.
 *
 * staging: tests are stubbed (`Deno.test.ignore`) until #227 grows a tech
...
// grows the wiring for Schema `nullable`.
...
const FIXTURE_DIR = fromFileUrl(
  new URL("../fixtures/schema-nullable/", import.meta.url),
);
...
Deno.test.ignore(
  "#227 (wip): Schema `nullable` — primary contract",
  () => {
    // staging: replace this stub once the tech spec on #227 pins down the
...
Deno.test.ignore(
  "#227 (wip): Schema `nullable` — refusal / edge case",
  () => {
    // staging: replace this stub once the tech spec on #227 pins the
