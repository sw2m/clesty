/**
 * Red-Gate scaffold for sw2m/clesty issue #384 — `enum` values of mixed types (3.1).
 *
 * staging: tests are stubbed (`Deno.test.ignore`) until #384 grows a tech
...
// grows the wiring for `enum` values of mixed types (3.1).
...
const FIXTURE_DIR = fromFileUrl(
  new URL("../fixtures/enum-values-of-mixed-types-3-1/", import.meta.url),
);
...
Deno.test.ignore(
  "#384 (wip): `enum` values of mixed types (3.1) — primary contract",
  () => {
    // staging: replace this stub once the tech spec on #384 pins down the
...
Deno.test.ignore(
  "#384 (wip): `enum` values of mixed types (3.1) — refusal / edge case",
  () => {
    // staging: replace this stub once the tech spec on #384 pins the
